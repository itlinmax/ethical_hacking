...
def deauth(target_mac, gateway_mac, inter=0.1, count=None, loop=1, iface="wlp3s0mon", verbose=1):
    # 802.11 frame
...
if __name__ == "__main__":
    ...
    parser.add_argument("target", help="Target MAC address to deauthenticate. You can also set the broadcast address ff:ff:ff:ff:ff:ff")
    ...
    parser.add_argument("-i", dest="iface", help="Interface to use, must be in monitor mode, default is 'wlp3s0mon'", default="wlp3s0mon" )
